...
<script src="<?php echo e(asset()); ?>js/pages/dashboard-main.js"></script>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <div class="d-inline-block align-middle">
                                        <img src="<?php echo e(asset()); ?>images/user/avatar-4.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="d-inline-block align-middle">
                                        <img src="<?php echo e(asset()); ?>images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                        <div class="d-inline-block">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="d-inline-block align-middle">
                                        <img src="<?php echo e(asset()); ?>images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15">
                                        <div class="d-inline-block">
                                            <h6>William Jem</h6>
                ...
                <div class="review-block">
                    <div class="row">
                        <div class="col-sm-auto p-r-0">
                            <img src="<?php echo e(asset()); ?>images/user/avatar-2.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col-sm-auto p-r-0">
                            <img src="<?php echo e(asset()); ?>images/user/avatar-4.jpg" alt="user image" class="img-radius profile-img cust-img m-b-15">
                        </div>
                        <div class="col">
            ...
            <div class="card-body">
                <div class="row m-b-20 received-chat">
                    <div class="col-auto p-r-0">
                        <img src="<?php echo e(asset()); ?>images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40">
                    </div>
                    <div class="col">
                        <div class="msg">
                ...
                <div class="row m-b-20 send-chat">
                    ...
                    <div class="col-auto p-l-0">
                        <img src="<?php echo e(asset()); ?>images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40">
                    </div>
                </div>
                <div class="row m-b-20 received-chat">
                    <div class="col-auto p-r-0">
                    ...
                    <div class="col">
                        <div class="msg">
                            <p class="m-b-0">Nice to meet you!</p>
                            <img src="<?php echo e(asset()); ?>images/widget/dashborad-1.jpg" alt="">
                            <img src="<?php echo e(asset()); ?>images/widget/dashborad-3.jpg" alt="">
                        </div>
                        <p class="text-muted m-b-0"><i class="fa fa-clock-o m-r-10"></i>10:20am</p>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MyServer\www\bincigar\app\views/dashboard.blade.php ENDPATH**/ ?>