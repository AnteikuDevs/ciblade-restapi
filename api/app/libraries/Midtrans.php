...
class Midtrans {
    ...
    {
      Midtrans::$isProduction = env('MIDTRANS_ENV') == 'production'? true : false;
      if (env('MIDTRANS_ENV') !== 'production') {
        Midtrans::$serverKey = env('MIDTRANS_SERVER_KEY_SANDBOX');
      }else{
        Midtrans::$serverKey = env('MIDTRANS_SERVER_KEY_PRODUCTION');
      }
    }
