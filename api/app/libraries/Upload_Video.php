...
class Upload_Video
{
    public function generate($file_base64,$path,$prefix = '',$old_video = '')
    {
        $tipe = explode(';base64,',$file_base64);
        $format = explode('data:video/',$tipe[0]);
        $file_base64 = str_replace('data:video/'.$format[1].';base64,', '', $file_base64);
